...
StandardAndDNAPhysics::StandardAndDNAPhysics():  G4VUserPhysicsList()
{
...
StandardAndDNAPhysics::~StandardAndDNAPhysics()
{}


void StandardAndDNAPhysics::ConstructParticle()
{
  ConstructBosons();
  ConstructLeptons();
  ConstructBarions();
...
void StandardAndDNAPhysics::ConstructBosons()
{ 
  // gamma
...
void StandardAndDNAPhysics::ConstructLeptons()
{
  // leptons
...
void StandardAndDNAPhysics::ConstructBarions()
{
  //  baryons
...
void StandardAndDNAPhysics::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
  ConstructGeneral();
...
void StandardAndDNAPhysics::ConstructEM()
{
...
void StandardAndDNAPhysics::ConstructGeneral()
{ }


void StandardAndDNAPhysics::SetCuts()
{
  if (verboseLevel >0)
  {
    G4cout << "StandardAndDNAPhysics::SetCuts:";
