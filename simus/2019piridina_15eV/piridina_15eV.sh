...
CHB=":MIXT_BY_NATOMS PIRIDINA_15eV $Dens 3  C 5 H 5 N 1
     :VOLU chb TUBE 0.0 8*cm/2 4*cm/2 PIRIDINA_15eV
...
GENDIST="$GENMONO	
	 /gamos/generator/energyDist gn GmGenerDistEnergyFromFile e15eV_june2019.txt interpolate 1*eV"
...
if [ $1 == "gen" ] ; then
    HEXIT="/gamos/setParam   UAExit:EnergyMax 17e-6
...
Resultados de las simulaciones con piridina con datos para 15eV.
