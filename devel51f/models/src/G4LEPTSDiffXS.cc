...
G4LEPTSDiffXS::G4LEPTSDiffXS(string file, string theParticle) {
  fileName = file;
...
G4double G4LEPTSDiffXS::RelativisticMomentum( G4double T) {
...
// F Interpolator
inline double G4LEPTSDiffXS::FF(int l, int e, int a, double E) {
...
// f Interpolator
inline double G4LEPTSDiffXS::ff(int e, int a, double E) {
  double x1, x2, y1, y2, x, y;
...
G4double G4LEPTSDiffXS::SampleAngle(G4double Energy, G4double El) {
  // loc Energy lost bin:
  int l=10*El/Energy;
