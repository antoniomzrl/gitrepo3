...
// ********************************************************************
//
// $Id: G4EmPenelopeLEPTSPhysics.cc 78898 2014-02-03 12:56:43Z gcosmo $
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4EmPenelopeLEPTSPhysics);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4EmPenelopeLEPTSPhysics::G4EmPenelopeLEPTSPhysics(G4double highELimit, G4int ver)
  : G4VPhysicsConstructor("G4EmPenelopeLEPTSPhysics"), verbose(ver)
{
  //t  theLEPTSHighEnergyLimit = highELimit;
...
G4EmPenelopeLEPTSPhysics::G4EmPenelopeLEPTSPhysics(G4double highELimit, G4int ver, const G4String&)
  : G4VPhysicsConstructor("G4EmPenelopeLEPTSPhysics"), verbose(ver)
{
  G4LossTableManager::Instance();
  SetPhysicsType(bElectromagnetic);
...
G4EmPenelopeLEPTSPhysics::~G4EmPenelopeLEPTSPhysics()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void G4EmPenelopeLEPTSPhysics::ConstructParticle()
{
// gamma
  G4Gamma::Gamma();
...
void G4EmPenelopeLEPTSPhysics::ConstructProcess()
{
  if(verbose > 1) {
