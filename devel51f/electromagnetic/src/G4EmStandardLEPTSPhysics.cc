...
// ********************************************************************
//
// $Id: G4EmStandardLEPTSPhysics.cc 78956 2014-02-05 09:48:17Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   G4EmStandardLEPTSPhysics
//
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4EmStandardLEPTSPhysics);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4EmStandardLEPTSPhysics::G4EmStandardLEPTSPhysics(G4double highELimit, G4int ver)
...
G4EmStandardLEPTSPhysics::G4EmStandardLEPTSPhysics(G4int ver, const G4String&)
  : G4VPhysicsConstructor("G4EmStandard"), verbose(ver)
{
  G4LossTableManager::Instance();
  SetPhysicsType(bElectromagnetic);
...
G4EmStandardLEPTSPhysics::~G4EmStandardLEPTSPhysics()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void G4EmStandardLEPTSPhysics::ConstructParticle()
{
// gamma
  G4Gamma::Gamma();
...
void G4EmStandardLEPTSPhysics::ConstructProcess()
{
  if(verbose > 1) {
